...
// Reported AUM per period and Avg AUM over a date range are both pure
// historical DB aggregates -- no DHAN calls, no polling needed.
// keepPreviousData avoids flashing back to the default figures while a new
// selection's fetch is still in flight.
export function useOverviewAdjustments(reportPeriod?: string, avgFrom?: string, avgTo?: string) {
